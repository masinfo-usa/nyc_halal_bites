...
export default function OrdersAPITest() {
          ...
          <ul>
            {order.lineItems?.map((item) => (
              <li key={item.uid}>
                ...
                — Subtotal: {formatMoney(item.basePriceMoney)} USD, Total: {formatMoney(item.totalMoney)}, Tax: {formatMoney(item.totalTaxMoney)},  Service: {formatMoney(item.totalServiceChargeMoney)}
              </li>
            ))}
          </ul>
